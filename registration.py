...
t1 = tk.Entry(window, textvar=Fullname,bd=2, width=20, font=('', 15))
...
t2 = tk.Entry(window, textvar=address, bd=2,width=20, font=('', 15))
...
t4 = tk.Entry(window, textvar=Email, bd=2,width=20, font=('', 15))
t4.place(x=800, y=250)
# that is for email address

l6 = tk.Label(window, text="Phone No :", width=12, font=("Times new roman", 15, "bold"), bg="white")
l6.place(x=550, y=300)
t5 = tk.Entry(window, textvar=Phoneno,bd=2, width=20, font=('', 15))
t5.place(x=800, y=300)
# phone number
l7 = tk.Label(window, text="Gender :", bd=2,width=12, font=("Times new roman", 15, "bold"), bg="white")
l7.place(x=550, y=350)

# t6 = tk.Entry(window,bd=2, width=15, font=('', 20))
# t6.place(x=800, y=350)
# gender
tk.Radiobutton(window, text="Male", padx=1,  bg="white", font=("bold", 15), variable=var, value=1).place(x=820,
                                                                                                                y=350)
tk.Radiobutton(window, text="Female", padx=1,  bg="white", font=("bold", 15), variable=var, value=2).place(
    x=920, y=350)

l8 = tk.Label(window, text="Age :", width=12, font=("Times new roman", 15, "bold"), bg="white")
l8.place(x=550, y=400)
t6 = tk.Entry(window, textvar=age,bd=2, width=20, font=('', 15))
t6.place(x=800, y=400)

l4 = tk.Label(window, text="User Name :", width=12, font=("Times new roman", 15, "bold"), bg="white")
l4.place(x=550, y=450)
t3 = tk.Entry(window, textvar=username, bd=2,width=20, font=('', 15))
t3.place(x=800, y=450)


l9 = tk.Label(window, text="Password :", width=12, font=("Times new roman", 15, "bold"), bg="white")
l9.place(x=550, y=500)
t9 = tk.Entry(window, textvar=password,bd=2 ,width=20, font=('', 15), show="*")
...
t10 = tk.Entry(window, textvar=password1, bd=2,width=20, font=('', 15), show="*")
t10.place(x=800, y=550)

btn = tk.Button(window, text="Create Account", bg="black",font=("",20),fg="white", width=15, height=0, command = insert)
