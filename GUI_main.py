...
root.title("Finger Verification  ")
...
#
label_l1 = tk.Label(root, text="Finger Verification",font=("Times New Roman", 25, 'bold'),
                    background="black", fg="white", width=70, height=1)
...
button1 = tk.Button(root, text="Home Page", command=log1, width=14, height=1,font=('times', 20, ' bold '), bg="black", fg="white")
button1.place(x=500, y=190)
