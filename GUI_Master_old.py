...
#
lbl = tk.Label(root, text="Fingerprint Verification", font=('times', 35,' bold '), height=1, width=55,bg="violet Red",fg="Black")
lbl.place(x=0, y=0)
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='finger print authentication', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
